...
mkdir /home/jarvislogs; chown root.admin /home/jarvislogs; chmod 770 /home/jarvislogs;
mkdir /mnt/diskbackup; chown jarvis:jarvis /mnt/diskbackup
mkdir /home/jarvisbackup; chown jarvis:jarvis /home/jarvisbackup;
mkdir /home/jarvisbackup/conf; chown jarvis:jarvis /home/jarvisbackup/conf;
mkdir /home/jarvisbackup/mysql; chown jarvis:jarvis /home/jarvisbackup/mysql;
mkdir /home/jarviswwwroot; chown jarvis:jarvis /home/jarviswwwroot
---------------

Check in /etc/passwd that the id of this user *admin* is greater than or equal to 1000.


Create a user account for yourself (or other administrators), for example: *myunixlogin*. It will be used to login remotely to server.
...
Add a swap on */swap/swap.img* if the disk is not SSD, otherwise on the non SSD disk */mnt/sdX/swap/swap.img*. If all the disks are SSD, do not add swap.
...
Delete the dir */home/jarvislogs* and replace it with a symbolic link to */mnt/disklog*
...
mkdir -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam;
...
chown -R jarvis:jarvis /home/jarviswwwroot/dolibarr
---------------
...
Install the NFS server and sharing on */home/jarviswwwroot/dolibarr_documents/sellyoursaas*
...
#
/home/jarviswwwroot/dolibarr_documents/sellyoursaas i.p.deployment.server1(ro,no_root_squash,sync,no_subtree_check)
...
/home/jarviswwwroot/dolibarr_documents/sellyoursaas i.p.deployment.serverN(ro,no_root_squash,sync,no_subtree_check)
---------------
...
sudo mount -t nfs i.p.server.master:/home/jarviswwwroot/dolibarr_documents/sellyoursaas /home/jarviswwwroot/dolibarr_documents/sellyoursaas
sudo umount /home/jarviswwwroot/dolibarr_documents/sellyoursaas
---------------
...
[source, bash]
---------------
i.p.server.master:/home/jarviswwwroot/dolibarr_documents/sellyoursaas /home/jarviswwwroot/dolibarr_documents/sellyoursaas  nfs  defaults 0 0
---------------
...
On the deployment servers, copy the public and private key of the master's ssh *admin* account to */home/jarvis.ssh/id_rsa_sellyoursaas...* (This couple of key file is the one common for maintenance to access osu... user accounts). Set the right permissions.

[source, bash]
---------------
chmod u+rw /home/jarvis.ssh/id_rsa_sellyoursaas*
chmod go-rw /home/jarvis.ssh/id_rsa_sellyoursaas*
chmod a+r /home/jarvis.ssh/id_rsa_sellyoursaas.pub
---------------


Complete the file */home/jarvis.ssh/config* to indicate to use this public key when accessing to itself or github instead of *id_rsa* by default.

[source, bash]
---------------
Host ip.server.deployment
    IdentityFile /home/jarvis.ssh/id_rsa_sellyoursaas
Host github.com
    IdentityFile /home/jarvis.ssh/id_rsa_sellyoursaas    
---------------
...
sudo apt install -y php php-cli libapache2-mod-php php-fpm php-gd php-imap php-json php-ldap php-mysqlnd php-curl php-memcached php-imagick php-geoip php-mcrypt php-intl php-xml php-zip php-bz2 php-ssh2 php-mbstring php-soap
...
<VirtualHost *:80>
        ...
        php_admin_value open_basedir /tmp/:/home/jarviswwwroot/:/usr/share/GeoIP:/home/jail/home

        ServerName      admin.mysaasdomainname.com
        DocumentRoot /home/jarviswwwroot/dolibarr/htdocs/
        ErrorLog     /home/jarvislogs/mycompany_admin_error_log
        CustomLog    /home/jarvislogs/mycompany_admin_access_log combined
        ...
        <Directory /home/jarviswwwroot/dolibarr/htdocs/>
        AuthType Basic
        ...
        <Directory /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/public/>
        AuthType None
        Require all granted
        Satisfy any
        </Directory>        
        <Directory /home/jarviswwwroot/dolibarr/htdocs/public/>
        AuthType None
        Require all granted
        Satisfy any
        </Directory>
        <Directory /home/jarviswwwroot/dolibarr/htdocs/api/>
        AuthType None
        Require all granted
        Satisfy any
        </Directory>
        <Directory /home/jarviswwwroot/dolibarr/htdocs/dav/>
        AuthType None
        Require all granted
        Satisfy any
        </Directory>
        ...
        Alias "/git" "/home/jarviswwwroot/dolibarr_documents/sellyoursaas/git"
        <Directory /home/jarviswwwroot/dolibarr_documents/sellyoursaas/git>
        AllowOverride FileInfo Limit
        Options +Indexes
        Order allow,deny
        Require ip 1.2.3.4
...
<VirtualHost *:80>
   ...
   php_admin_value open_basedir /tmp/:/home/jarviswwwroot/:/usr/share/GeoIP:/home/jarvistools/

   UseCanonicalName On
   ServerName   myaccount.mysaasdomainname.com
   ErrorLog     /home/jarvislogs/mysaas_myaccount_error_log
   CustomLog    /home/jarvislogs/mysaas_myaccount_access_log combined

   DocumentRoot /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/myaccount

   <Directory /home/jarviswwwroot/dolibarr_sellyoursaas/myaccount>
   ...
   # To access images
   <Directory /home/jarviswwwroot/dolibarr_documents>
   AllowOverride FileInfo Options
   Options       -Indexes -MultiViews +FollowSymLinks -ExecCGI
   Require all granted
   </Directory>
...
[source, bash]
---------------
/home/jarviswwwroot/dolibarr_sellyoursaas/scripts/firewallsellyoursaasufw.sh start
---------------
...
* Installation and activation of the apache watchdogs provided in */home/jarviswwwroot/dolibarr_sellyoursaas/scripts/* by creating a link by

[source, bash]
---------------
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/apache_watchdog_launcher1.sh /etc/init.d/apache_watchdog_launcher1
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/apache_watchdog_launcher2.sh /etc/init.d/apache_watchdog_launcher2
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/apache_watchdog_launcher3.sh /etc/init.d/apache_watchdog_launcher3
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/smtp_watchdog_launcher1.sh /etc/init.d/smtp_watchdog_launcher1
systemctl daemon-reload
...
* Agent installation and activation in */home/jarviswwwroot/dolibarr_sellyoursaas/scripts/remote_server_launcher.sh* by creating a link by

[source, bash]
---------------
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/remote_server_launcher.sh /etc/init.d/remote_server_launcher
systemctl daemon-reload
...
[Unit]
 ...
 RequiresMountsFor=/home/jarviswwwroot/dolibarr_documents/sellyoursaas
...
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/email-dolibarr-ruleskoblacklist.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/email-dolibarr-ruleskoquota.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/email-dolibarr-rulesko.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/email-dolibarr-rulesall.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/email-dolibarr-rulesadmin.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/web-accesslog-limit403.conf
...
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/filter.d/web-dolibarr-ruleslimitpublic.conf
...
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/email-dolibarr-ruleskoblacklist.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/email-dolibarr-ruleskoquota.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/email-dolibarr-rulesko.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/email-dolibarr-rulesall.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/email-dolibarr-rulesadmin.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/web-accesslog-limit403.conf
---------------
...
---------------
cd /etc/fail2ban/jail.d
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/web-dolibarr-rulespassforgotten.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/web-dolibarr-rulesbruteforce.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/web-dolibarr-ruleslimitpublic.conf
ln -fs /home/jarviswwwroot/dolibarr_sellyoursaas/etc/fail2ban/jail.d/web-dolibarr-rulesregisterinstance.conf
---------------
...
Comment the line into */etc/mysql/mariadb.conf.d/50-mysqld_safe.cnf* (if not the error log file will not be isolated into the /var/log/mysql/mysql.log file):
...
[source,bash]
---------------
mv commonjail.tgz privatejail.tgz /home/jarviswwwroot/dolibarr_documents/sellyoursaas/scripts/templates/
---------------
...
[source,bash]
---------------
echo >> /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistmail;
echo >> /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistip;
echo >> /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistfrom;
echo >> /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistcontent;
---------------
...
[source,bash]
---------------
ln -fs /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/phpsendmailprepend.php /usr/local/bin/
ln -fs /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/phpsendmail.php /usr/local/bin/
---------------
...
[source,bash]
---------------
ln /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/phpsendmailprepend.php /usr/local/bin/
ln /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/phpsendmail.php /usr/local/bin/
---------------
...
[source,bash]
---------------
mkdir -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam;
chown admin.www-data /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local;
chmod a+rwx /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local;
---------------
...
[source,bash]
---------------
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistmail /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistmail;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistip /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistip;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistfrom /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistfrom;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas/spam/blacklistcontent /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistcontent;
chmod a+rwx /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam; chmod a+rw /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/*;


mkdir /tmp/spam;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistmail /tmp/spam/;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistip /tmp/spam/;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistfrom /tmp/spam/;
cp -p /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/blacklistcontent /tmp/spam/;
...
[source,bash]
---------------
certbot certonly -n --manual-public-ip-logging-ok --server https://acme-v02.api.letsencrypt.org/directory --agree-tos --manual --preferred-challenges=dns --manual-auth-hook /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/letsencrypt_authenticator.sh -d "*.with<X>.<your_domain>,with<X>.<your_domain>" -m <email_for_your_account_with_lets_encrypt> --deploy-hook "systemctl restart apache2" [--expand]
---------------
...
NOTE: This is the wildcard certificate that will be used for the customer instances. Custom certificates for instances will be saved into */home/jarviswwwroot/dolibarr_documents/sellyoursaas/crt*
...
# m h  dom mon dow   command
# cron master admin
*/10 * * * * /home/jarviswwwroot/dolibarr/scripts/cron/cron_run_jobs.php <securitykeydefinedinscheduledjobsetup> anonymousbatch >> /home/jarviswwwroot/dolibarr_documents/cron_run_jobs.php.log 2>&1
5 5 * * 0 /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/batch_customers.php updatestatsonly >> /home/jarvislogs/batch_customers-updatedatabase.log 2>&1
7 7 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/git_update_sources.sh /home/jarviswwwroot/dolibarr_documents/sellyoursaas/git >> /home/jarvislogs/git_update_sources.log 2>&1
...
10 0 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/backup_mysql_system.sh confirm >/home/jarvislogs/backup_mysql_system.log 2>&1
00 4 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/perms.ksh >/home/jarvislogs/perms.log
40 15 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/backup_backups.sh confirm none --delete >/home/jarvislogs/backup_backups.log 2>&1
00 9 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/batch_detect_evil_instances.php test 86400 > /home/jarvislogs/batch_detect_evil_instances.log 2>&1
#40 4 4 * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/clean.sh confirm
---------------
...
# cron master and deployment root
#7 7 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/git_update_sellyoursaas.sh /home/jarviswwwroot >> /home/jarvislogs/git_update_sellyoursaas.log 2>&1
20 0 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/batch_customers.php backup >> /home/jarvislogs/batch_customers-backup.log 2>&1
---------------
...
* Create a symbolic link called *main.inc.php* into directory *myaccount* that point to */home/jarviswwwroot/dolibarr/htdocs/main.inc.php* :

[source,bash]
---------------
ln -fs /home/jarviswwwroot/dolibarr/htdocs/main.inc.php /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/myaccount
---------------
...
* Call the URL to install Dolibarr. Warning: Choose, during the installation wizard, the name of the document directory as */home/jarviswwwroot/dolibarr_documents* rather than */home/jarviswwwroot/dolibarr/documents*
...
* Create a file */home/jarviswwwroot/dolibarr/htdocs/conf/conf.php*:

[source,ini]
---------------
sudo vi /home/jarviswwwroot/dolibarr/htdocs/conf/conf.php
---------------
...
---------------
<?php
$dolibarr_main_document_root='/home/jarviswwwroot/dolibarr/htdocs';
$dolibarr_main_data_root='/home/jarviswwwroot/dolibarr_documents';
---------------
...
mkdir /home/jarvistools/maxmind/ -p
...
chmod -R o-w /home/jarvistools/maxmind
...
instances:
  ...
  - use_mount: false
    ...
    mount_point_exclude:
        - /home/jarviswwwroot/dolibarr_documents/sellyoursaas
...
*/home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/batch_customers.php backup*
...
*/home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/git_update_sources.sh /home/jarviswwwroot/dolibarr_documents/sellyoursaas/git*


=== Update Sell-Your-Saas statistics

- A cron script on *Master* calulates statistics: 
*/home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/batch_customers.php updatestatsonly*
...
999GB    (Don't input the default value but the max value of disk size found on line "Disk...:" that was shown by "print all")
q
---------------
...
[source,bash]
---------------
/home/jarviswwwroot/dolibarr_documents/sellyoursaas <deployment.server.IP>(ro,no_root_squash,sync,no_subtree_check)
---------------
...
[source,bash]
---------------
<master.server.IP>:/home/jarviswwwroot/dolibarr_documents/sellyoursaas /home/jarviswwwroot/dolibarr_documents/sellyoursaas  nfs  defaults 0 0
---------------

- Allow access between the new *Deployment server* and the *Master server* in the firewall.

*If using iptables* (old method)
...
[source,bash]
---------------
/home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/clean.sh confirm
---------------
...
==== Error sometimes when sendig emails with Gmail
...
or into the apache error log file:
...
==== On a deployment server, the user root can read files into /home/jarviswwwroot/dolibarr_documents/sellyoursaas
