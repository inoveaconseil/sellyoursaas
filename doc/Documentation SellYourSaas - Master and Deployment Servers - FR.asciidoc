...
mkdir /home/jarvisbackup; chown admin.admin /home/jarvisbackup;
mkdir /home/jarvisbackup/conf; chown admin.admin /home/jarvisbackup/conf;
mkdir /home/jarvisbackup/mysql; chown admin.admin /home/jarvisbackup/mysql;
...
* Under the *admin* account, retrieve the sources of *Dolibarr* (v14 or +) to be placed in */home/jarviswwwroot/dolibarr*
...
Installer le serveur NFS et le partage sur */home/jarviswwwroot/dolibarr_documents/sellyoursaas*
...
Sur les serveurs de déploiement, copier la clé publique et privé du compte ssh *admin* du master en */home/jarvis.ssh/id_rsa_sellyoursaas...* (Ce couple de fichier est celui commun pour la maintenance pour accéder aux comptes utilisateurs). Mettre les bons droits.
...
Compléter le fichier */home/jarvis.ssh/config* pour indiquer d'utiliser cette clé publique lors d'accès à lui même ou github au lieu de *id_rsa* par défaut.
...
<VirtualHost *:80>
        ...
        php_admin_value open_basedir /tmp/:/home/jarviswwwroot/:/usr/share/GeoIP:/home/jail/home:/home/jarvisbackup/dump:/home/jarvistools/
...
* Installation et activation des watchdogs Apache fournis dans */home/jarviswwwroot/dolibarr_sellyoursaas/scripts/* en créant un lien par
...
* Installation et activation de l'agent dans */home/jarviswwwroot/dolibarr_sellyoursaas/scripts/remote_server_launcher.sh* en créant un lien par
...
/{usr/,}bin/secureBash {
  ...
  /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/phpsendmail.php rix,
  /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/phpsendmailprepend.php rix,
  /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/ rw,
  /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/** rw,
...
profile apache2 /usr/{bin,sbin}/apache2 flags=(attach_disconnected) {
  ...
  ^DEFAULT_URI flags=(attach_disconnected) {
    ...
    /home/jarviswwwroot/dolibarr_documents/sellyoursaas_local/spam/** rw,
    /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/phpsendmail.php rix,
    /home/jarviswwwroot/dolibarr_sellyoursaas/scripts/phpsendmailprepend.php r,
...
NOTE: Il s'agit ici du certificat qui sera utilisé pour les instances clients. Les certificats custom des instances seront dans */home/jarviswwwroot/dolibarr_documents/sellyoursaas/crt*
...
#47 2 * * * /root/certbot-auto renew --no-self-upgrade > /var/log/letsencrypt/certbot-auto_renew.log 2>&1
10 0 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/backup_mysql_system.sh confirm >/home/jarvislogs/backup_mysql_system.log 2>&1
30 3 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/perms.ksh >/home/jarvislogs/perms.log
40 4 * * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/backup_backups.sh confirm >/home/jarvislogs/backup_backups.log 2>&1
#40 4 4 * * /home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/clean.sh confirm
---------------
...
* Créer un lien symbolique appelé *sellyoursaas* dans */home/jarviswwwroot/dolibarr/htdocs/custom* vers */home/jarviswwwroot/dolibarr_sellyoursaas* :
...
* Créer un lien symoblique appelé *source* dans *myaccounts* vers */home/jarviswwwroot/dolibarr/htdocs* :
...
* Créer un lien symbolique appelé *main.inc.php* dans *myaccount* vers */home/jarviswwwroot/dolibarr/htdocs/main.inc.php* :
...
* Appeler l'URL pour lancer l'installation de Dolibarr. Attention: Choisissez lors de l'assistant d'installation, comme nom de répertoire document */home/jarviswwwroot/dolibarr_documents* plutôt que */home/jarviswwwroot/dolibarr/documents*
...
* Créer un fichier */home/jarviswwwroot/dolibarr/htdocs/conf/conf.php*:
...
*/home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/backup_mysql_system.sh confirm* de *root* (voir <<installation_des_taches_cron>>) vers le disque */home/jarvisbackup/conf* et */home/jarvisbackup/mysql*

- Une sauvegarde locale des instances utilisateurs payantes est assurée par le cron 

*/home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/batch_customers.php backup* de *admin* (voir <<installation_des_taches_cron>>) vers le disque */mnt/diskbackup/backup/osu*


===== Sauvegarde distante

- Une sauvegarde externe doit être assurée vers un autre serveur par le cron de l'utilisateur *root* en lançant le fichier */home/jarviswwwroot/dolibarr/htdocs/custom/sellyoursaas/scripts/backup_backups.sh confirm >/home/jarvislogs/backup_backups.log 2>&1* pour copier de */mnt/diskbackup/backup* vers */mnt/diskbackup/backup_serversource* (d'un autre serveur sur un autre datacenter). Ce script est intégré dans la crontab de root (Voir <<installation_des_taches_cron>>).
...
[source,bash]
---------------
/home/jarviswwwroot/dolibarr_documents/sellyoursaas i.p.deployment.server(ro,no_root_squash,sync,no_subtree_check)
---------------
...
[source,bash]
---------------
ip.server.master:/home/jarviswwwroot/dolibarr_documents/sellyoursaas /home/jarviswwwroot/dolibarr_documents/sellyoursaas  nfs  defaults 0 0
---------------
