...
if [[ "$mode" == "deploywebsite" ]]; then
	...
	echo "Create cert directory with mkdir /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/; chown jarvis:jarvis /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/;"
	mkdir /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/; chown jarvis:jarvis /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/;
	...
	echo "Link certificate for virtualhost with
		ln -fs /etc/letsencrypt/live/www.$CUSTOMDOMAIN/privkey.pem /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/$instancename.$domainname-$CUSTOMDOMAIN.key
		ln -fs /etc/letsencrypt/live/www.$CUSTOMDOMAIN/cert.pem /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/$instancename.$domainname-$CUSTOMDOMAIN.crt
		ln -fs /etc/letsencrypt/live/www.$CUSTOMDOMAIN/fullchain.pem /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/$instancename.$domainname-$CUSTOMDOMAIN-intermediate.crt
	"
	ln -fs /etc/letsencrypt/live/www.$CUSTOMDOMAIN/privkey.pem /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/$instancename.$domainname-$CUSTOMDOMAIN.key
	ln -fs /etc/letsencrypt/live/www.$CUSTOMDOMAIN/cert.pem /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/$instancename.$domainname-$CUSTOMDOMAIN.crt
	ln -fs /etc/letsencrypt/live/www.$CUSTOMDOMAIN/fullchain.pem /home/jarvis/wwwroot/dolibarr_documents/sellyoursaas_local/crt/$instancename.$domainname-$CUSTOMDOMAIN-intermediate.crt
